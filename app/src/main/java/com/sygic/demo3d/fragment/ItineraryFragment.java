...
public class ItineraryFragment extends Fragment {
                ...
                new SdkThread(getActivity(), mHandler) {
                    ...
                    public void execSdkCommand() {
                        try {
                            ...
                            Log.e(SecondActivity.LOG_TAG, "No itinerary added!");
                            e.printStackTrace();
                        }
                    }
                }.start();
        ...
        rootView.findViewById(R.id.btn_del).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new SdkThread(getActivity(), mHandler) {
                    ...
                    public void execSdkCommand() {
                        try {
                            ApiItinerary.deleteItinerary(ITINERARY_TEST, SecondActivity.API_CALL_TIMEOUT);
        ...
        new SdkThread(getActivity(), mHandler) {
            ...
            public void execSdkCommand() {
                try {
                    ...
                    ApiItinerary.addEntryToItinerary(ITINERARY_TEST, sop, 1, SecondActivity.API_CALL_TIMEOUT);
                } catch (GeneralException e) {
                    e.printStackTrace();
                }
            }
    ...
    private void refreshList(final String name) {
        ...
        new SdkThread(getActivity(), mHandler) {
            ...
            public void execSdkCommand() {
                try {
                    mItinerary = ApiItinerary.getItineraryList(name, SecondActivity.API_CALL_TIMEOUT);
                } catch (GeneralException e) {
                    e.printStackTrace();
                }
            }
    ...
    public void removeEntry(final View v) {
        new SdkThread(getActivity(), mHandler) {
            ...
            public void execSdkCommand() {
                try {
                    ApiItinerary.deleteEntryInItinerary(ITINERARY_TEST, holder.pos, SecondActivity.API_CALL_TIMEOUT);
                } catch (GeneralException e) {
                    e.printStackTrace();
                }
            }
