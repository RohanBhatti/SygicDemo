...
import com.sygic.demo3d.fragment.ItineraryFragment;
import com.sygic.demo3d.fragment.LocationFragment;
import com.sygic.demo3d.fragment.PoiFragment;
        ...
        if(resourceManager.shouldUpdateResources()) {
            ...
            resourceManager.updateResources(new ResourceManager.OnResultListener() {
                ...
                public void onError(int errorCode, @NotNull String message) {
                    Toast.makeText(SecondActivity.this, "Failed to update resources: " + message, Toast.LENGTH_LONG).show();
                    finish();
                }
